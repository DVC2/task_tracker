...
/**
 * Deep clone an object using JSON.parse(JSON.stringify(obj)).
 * IMPORTANT: This method has limitations:
 * - Does not clone functions.
 * - Converts Date objects to ISO strings.
 * - Does not clone RegExp, Map, Set, or undefined values correctly.
 * - Cannot clone objects with circular references.
 * - Loses prototype chain of custom class instances.
 * Suitable for simple, JSON-serializable objects.
